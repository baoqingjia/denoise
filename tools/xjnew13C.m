...
fidname{1}='E:\topspindata\data\400.3.2mm.20221116\2020\fid';
fidname{2}='E:\topspindata\data\400.3.2mm.20221116\2021\fid';
fidname{3}='E:\topspindata\data\400.3.2mm.20221116\2022\fid';
fidname{4}='E:\topspindata\data\400.3.2mm.20221116\2023\fid';
fidname{5}='E:\topspindata\data\400.3.2mm.20221116\2024\fid';
fidname{6}='E:\topspindata\data\400.3.2mm.20221116\2025\fid';
fidname{7}='E:\topspindata\data\400.3.2mm.20221116\2026\fid';
fidname{8}='E:\topspindata\data\400.3.2mm.20221116\2027\fid';
fidname{9}='E:\topspindata\data\400.3.2mm.20221116\2028\fid';
fidname{10}='E:\topspindata\data\400.3.2mm.20221116\2029\fid';
fidname{11}='E:\topspindata\data\400.3.2mm.20221116\2030\fid';
fidname{12}='E:\topspindata\data\400.3.2mm.20221116\2031\fid';
fidname{13}='E:\topspindata\data\400.3.2mm.20221116\2032\fid';
fidname{14}='E:\topspindata\data\400.3.2mm.20221116\2033\fid';
fidname{15}='E:\topspindata\data\400.3.2mm.20221116\2034\fid';
fidname{16}='E:\topspindata\data\400.3.2mm.20221116\2035\fid';
...
idealFid=((sum(abs(SpecAll),2)));
%filePath = 'E:\topspindata\data1\400.3.2mm.20221116\3104\pdata\1\';
%fileName = '1r';
...
%IdealSpecdata=IdealSpecdata(3000-62:4924+61);
...
for k=1:length(noiseLevel)
    ...
    imgWaveletMultiframe = waveletMultiFrame(imgNoiseVol, 'k', 4, 'p', 5, 'windowSize',2,'maxLevel', 5, 'weightMode', 4, 'basis', 'dualTree','theta1');
...
figure;plot((real(sum(imgWaveletMultiframe,2)))/32);legend('WDMS');  
figure;plot(real(NMR_denoisedWavelet));legend('WT');               
figure;plot(real(NMR_denoised));legend('WDMS+WT');                      
