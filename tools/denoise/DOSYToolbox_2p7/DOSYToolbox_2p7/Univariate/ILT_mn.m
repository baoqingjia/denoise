...
%   Copyright  2007-2011  <Mathias Nilsson>
...
for i=1:npeaks
    ...
    switch OptimLambda
        case 0 %manual
            RegLambda=ILTOpts(5);
        case 1 %l-curve
            [RegLambda,rho,eta,reg_param] = l_curve(U,sigma,decay,'Tikh');
        case 2 %gcv
            [RegLambda,G,reg_param] = gcv(U,sigma,decay,'Tikh');
        otherwise
    end
        ...
        case 1 %Tikhonov
            switch Constraint
                case 0 %none
                    ...
                    [DiffusionDistribution,rho,eta] = tikhonov(U,sigma,V,DecayArray,RegLambda);
