fidname{1}='I:\topspindata\topspindata\500.4mm.20220818\2003\fid';
%fidname{2}='I:\topspindata\topspindata\500.4mm.20220818\2003\fid';
%fidname{3}='I:\topspindata\topspindata\500.4mm.20220818\2004\fid';
...
for i=1:size(fidname,2)
    ...
    fid000=fid00(:,1)+1i*((fid00(:,2)));    fid01=fid000;
    OneEchoPoint=570;
...
for iSilce=1:ImagShowNum
 ...
 imgNoiseVol=abs(imgNoiseVol)/max(clabs(imgNoiseVol(:)));
