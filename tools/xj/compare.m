...
NMR_denoisedreal = wavDenoise(NMR_signal2Dreal,10);
...
%% ssim Compare
 ...
 disp('ssim Compare')
    ...
    ssimWDMS=ssim(MultiFrameDenoiseSpec1(SignalRegion)/max(MultiFrameDenoiseSpec1),real(Original(SignalRegion))/max(real(Original)));
    ssimMultiFrame2=ssim(MultiFrameDenoiseSpec2(SignalRegion)/max(MultiFrameDenoiseSpec2),real(Original(SignalRegion))/max(real(Original)));
    ssimWaveDenoise2=ssim(WaveDenoise2(SignalRegion)/max(WaveDenoise2),real(Original(SignalRegion))/max(real(Original)));
