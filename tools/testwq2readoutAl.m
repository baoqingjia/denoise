...
fidname{9}='D:\topspin\data\MIL53\991\fid';
fidname{10}='D:\topspin\data\MIL53\990\fid';
fidname{11}='D:\topspin\data\MIL53\989\fid';
fidname{12}='D:\topspin\data\MIL53\988\fid';
fidname{13}='D:\topspin\data\MIL53\987\fid';
fidname{14}='D:\topspin\data\MIL53\986\fid';
fidname{15}='D:\topspin\data\MIL53\985\fid';
fidname{16}='D:\topspin\data\MIL53\984\fid';
fidname{1}='D:\topspin\data\MIL53\983\fid';
fidname{2}='D:\topspin\data\MIL53\982\fid';
fidname{3}='D:\topspin\data\MIL53\981\fid';
fidname{4}='D:\topspin\data\MIL53\980\fid';
fidname{5}='D:\topspin\data\MIL53\979\fid';
fidname{6}='D:\topspin\data\MIL53\978\fid';
fidname{7}='D:\topspin\data\MIL53\977\fid';
fidname{8}='D:\topspin\data\MIL53\976\fid';
...
%  figure;plot(abs(fftshift(fft(fid02))))
 ...
 ImgimgWaveletMultiframe = waveletMultiFrame(ImgimgNoiseVol, 'k', 8, 'p', 10, 'maxLevel', 5, 'weightMode',4, 'basis', 'dualTree');
 ...
 FileStr={'1r' '1i'};
 DataCell={abs(sum(Phase,2)),imag(sum(Phase,2))};
 WritePath=['D:\topspin\data\MIL53\9999\pdata\1\'];
