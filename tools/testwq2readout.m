...
sumspe=sumspe+spe{i};
 ...
 WritePath=['E:\topspindata\data\400.3.2mm.20221116\9999\pdata\1\'];
...
figure;plot(abs(sum(Phase,2)));

snr_value = snr((abs(sum(Phase,2))),(abs(NMR_signal)));
